...
EOF
        ...
        mkfs.ext4 -F -O has_journal -J size=512 -E stride=16,stripe-width=16 -L extroot ${XTDEVICE}
...
echo "                                                 "
echo "- QICK - EXTROOT OPENWRT v0.2i (c) 2021 - modded -"
echo "_________________________________________________"
echo
